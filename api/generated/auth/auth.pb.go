...
const file_api_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/auth.proto\x12\vhcp.auth.v1\"F\n" +
	...
	"\n" +
	"last_login\x18\a \x01(\tR\tlastLogin\"6\n" +
	"\rLoginResponse\x12%\n" +
	"\x04user\x18\x01 \x01(\v2\x11.hcp.auth.v1.UserR\x04user2M\n" +
	"\vAuthService\x12>\n" +
	"\x05Login\x12\x19.hcp.auth.v1.LoginRequest\x1a\x1a.hcp.auth.v1.LoginResponseB6Z4github.com/fffeng99999/hcp-server/api/generated/authb\x06proto3"
...
var file_api_proto_auth_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: hcp.auth.v1.LoginRequest
	(*User)(nil),          // 1: hcp.auth.v1.User
	(*LoginResponse)(nil), // 2: hcp.auth.v1.LoginResponse
}
var file_api_proto_auth_proto_depIdxs = []int32{
	1, // 0: hcp.auth.v1.LoginResponse.user:type_name -> hcp.auth.v1.User
	0, // 1: hcp.auth.v1.AuthService.Login:input_type -> hcp.auth.v1.LoginRequest
	2, // 2: hcp.auth.v1.AuthService.Login:output_type -> hcp.auth.v1.LoginResponse
